...
template<class t>
stc c0{ virtual t f(void*)=0; virtual ~c0(){} };
template<class t>
stc c1:c0<t>{
    function<t(void*)> g;
    c1(function<t(void*)> _g):g(_g){}
    t f(void* x){ return g(x); }
};
stc c2{ void* p; c2(void* x):p(x){} void* g(){ return p; } };
ll fd2(ll x){
...
void sol(){
    ...
    fr(i,0,n){
        ll v; iin>>v;
        *(reinterpret_cast<ll*>(a.data())+i)=v;
    }
    fr(i,0,n){
        ii rc=0;
        vpii ev;
