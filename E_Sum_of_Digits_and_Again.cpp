    ...
    void operator()(){
        ...
        ([&](){
            ...
            fr(s2,ss,st+1){
                ...
                wh(cu>9){
                    ii nx=0;
                    dv<ii>* ob=reinterpret_cast<dv<ii>*>(new dg<ii>());
                    ii tp=ob->f(static_cast<ii>(cu));
                    ii* pp=reinterpret_cast<ii*>(&tp);
                    wh((*pp)>0){
                        ii md=static_cast<ii>((*pp)%10);
                        ii* np=reinterpret_cast<ii*>(&nx);
                        *np=static_cast<ii>(*np+md);
                        *pp=static_cast<ii>((*pp)/10);
                    }
                    cu=static_cast<ii>(nx);
                    ii* rp=reinterpret_cast<ii*>(&rq);
                    *rp=static_cast<ii>(*rp+cu);
                    vi* vp=reinterpret_cast<vi*>(&sq);
                    vp->pb(static_cast<ii>(cu));
                    delete reinterpret_cast<dg<ii>*>(ob);
                }
                rq+=cu;
                (rq==st)?
                ([&](){
...
int32_t main(){
    ...
    ii t;
    iin>>t;
    ab<ii>* p=reinterpret_cast<ab<ii>*>(new cd<ii>());
    ef<ii> q(static_cast<ii>(p->go(0)));
    gh r;
    fr(i,0,t){
        aut lm=[&](){
            r();
    ...
    delete reinterpret_cast<cd<ii>*>(p);
}