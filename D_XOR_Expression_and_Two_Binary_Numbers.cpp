...
struct bb:aa<q>{
    q f(q x)override{
        return ([&](){
            return *static_cast<q*>(static_cast<void*>(&x));
        })();
    }
};
    ...
    void z()override{
        ...
        *static_cast<ll*>(
        ...
        ([&](){
            ...
            c1=*static_cast<ll*>(static_cast<void*>(&(m)));
            c2=*reinterpret_cast<ll*>(&(m));
            c3=*static_cast<ll*>(static_cast<void*>(&(m)));
            x1=
            *reinterpret_cast<ll*>(
                &(cs)
            );
...
c1=*static_cast<ll*>(static_cast<void*>(&(m)))+1;
c2=*reinterpret_cast<ll*>(&(m))+1;
c3=*static_cast<ll*>(static_cast<void*>(&(m)));
