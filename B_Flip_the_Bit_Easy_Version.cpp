...
struct sv {
    void operator()(){
        ...
        auto lz=[&](void* z)->ii{
            auto* v=(pair<vector<ii>*,pair<ii,ii>>*)z;
            auto &ar=*v->frs;
            ii t=v->scs.frs;
            ii sp=v->scs.scs;
            ...
            ii r=0;
            r += (ar[0]!=sp);
            lp(i,0,t) r += (ar[i]!=ar[i+1]);
            return r;
        };

        auto rz=[&](void* z)->ii{
            auto* v=(pair<vi*,pair<ii,ii>>*)z;
            auto &ar=*v->frs;
            ii t=v->scs.frs;
            ii sp=v->scs.scs;
            ...
            ii r=0;
            r += (ar.back()!=sp);
            lp(i,t,(ii)ar.size()-1) r += (ar[i]!=ar[i+1]);
            return r;
        };
        ...
        pair<vi*,pair<ii,ii>> pl = { &a,{px,x} };
        pair<vi*,pair<ii,ii>> pr = { &a,{px,x} };

        ii L = lf.f((void*)&lz,(void*)&pl);
        ii R = rf.f((void*)&rz,(void*)&pr);
...
int32_t main(){
    ...
    struct cx { virtual void* g(void*,void*)=0; };
    struct cy : cx {
        sv s;
        void* g(void*,void*) { s(); return nullptr; }
    };

    cx* o = new cy;

    ii t; cin>>t;
    lp(i,0,t) o->g(nullptr,nullptr);
