...
template<class t>
stc aa{
    virtual ll go(void*,void*)=0;
    virtual ~aa(){}
};
template<class t>
stc bb:aa<t>{
    ll (*fn)(void*,void*);
    ll go(void* x,void* y) override{
        return fn(x,y);
    }
};
template<class t>
ll ck(void* x,void* y){
    ll* a = reinterpret_cast<ll*>(x);
    ll* b = reinterpret_cast<ll*>(y);
    return (*a<*b)?1:0;
}
void sv(){
    ii n;
...
int32_t main(){
    nfio
    struct oo{ virtual void o(){} virtual ~oo(){} };
    struct so:oo{ void o() override{} };
