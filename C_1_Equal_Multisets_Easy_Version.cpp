...
template<class t> stc bx{
    virtual void* f(void*,void*,void*,void*,void*)=0;
    virtual ~bx()=default;
};

template<class t> stc by:bx<t>{
    void* f(void* a,void* b,void* c,void* d,void* e) override {
        aut n = (ii*)a;
        aut k = (ii*)b;
        aut aa = (vi*)c;
        aut bb = (vi*)d;
        ...
        vchr al(*n+1,0), us(*n+1,0);

        (lf<=rf ?
            [&](){ lp(i,lf,rf+1) al[(*aa)[i]] = 1; }() :
            (void)0
        );
        ii ok = 1;
        lp(i,0,*n){
...
stc slv{
    ...
    void go(){
        by<ii> o;
        void* p=&n; void* q=&k; void* u=&a; void* v=&b; void* w=&r;
        o.f(p,q,u,v,w);
    }
};
...
int32_t main(){
    ...
    stc op{ virtual void run(slv&s)=0; };
    stc qp:op{
        void run(slv&s) override { aut L=[&](){ s.go(); }; L(); }
    } q;
