...
struct bb:aa<t>{
    ...
    t f(t n,t a,t b) override{

        re(3*(*reinterpret_cast<t*>(&a))<=(*reinterpret_cast<t*>(&b)))?((*reinterpret_cast<t*>(&n))*(*reinterpret_cast<t*>(&a))):(((*reinterpret_cast<t*>(&n))/3)*(*reinterpret_cast<t*>(&b))+min(((*reinterpret_cast<t*>(&n))%3)*(*reinterpret_cast<t*>(&a)),(*reinterpret_cast<t*>(&b))));
    }
};
...
void slv(){
    ...
    cout<<p->f(*reinterpret_cast<ll*>(&n),*reinterpret_cast<ll*>(&a),*reinterpret_cast<ll*>(&b))<<"\n";
