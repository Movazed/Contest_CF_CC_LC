...
struct bb:aa<q>{
    q f(q x)override{
        return ([&](){return *static_cast<q*>(static_cast<void*>(&x));})();
    }
};
...
struct dd:cc{
    ...
    void z()override{
        ...
        fr(i,0,n)
            iin>>*static_cast<ii*>(static_cast<void*>(&(a[i])));

        sort(reinterpret_cast<vi*>(&a)->rbegin(),
             reinterpret_cast<vi*>(&a)->rend());
        ...
        fr(i,0,n-2){
            ...
            ii y=*reinterpret_cast<ii*>(&(a[i+1]));
            ii z=*reinterpret_cast<ii*>(&(a[i+2]));
        ...
        ok?
        pri
        <<*static_cast<ii*>(static_cast<void*>(&(a[0])))
        <<" "
        <<*static_cast<ii*>(static_cast<void*>(&(a[1])))
        <<nl
        :
        pri<<-1<<nl;
    }
