...
struct slv {
    void operator()() {
        ...
        lp(i,0,n){
            ll a; 
            iin>>a;
            s = ((ll(*)(ll,ll))[](ll p,ll q){return p+q;})(s,a);
        }
        ...
        pair<ll,ll> pr = { (s%2)!=0 , ((n*k)%2)==0 };

        ll r = (ll)fx.x((void*)&lm,(void*)&pr);
...
int32_t main(){
    ...
    struct c0 { virtual void* f(void*,void*)=0; };
    struct c1 : c0 {
        slv s;
        void* f(void*,void*) override { s(); return nullptr; }
    };
