...
struct a0{ virtual void rn(void*)=0; virtual ~a0(){} };
struct a1{ virtual void rn(a0*,void*)=0; virtual ~a1(){} };
struct a2{ virtual void rn(a1*,a0*,void*)=0; virtual ~a2(){} };

template<class T>
struct h0{ static void g(T& x){ x(); } };
...
struct dp:a0{
    void rn(void* pv) override{
        ...
        (void)([&](){
            --c;
            vs s(static_cast<size_t>(n));
            fl(i,n) iin>>s[static_cast<size_t>(i)];
            vb rc(static_cast<size_t>(n),false);
            vb sg(static_cast<size_t>(n),false);
            vb sc(static_cast<size_t>(n),true);
            rc[static_cast<size_t>(c)]=true;
            sg[static_cast<size_t>(c)]=true;
            ii r=n-2;
            wl(r>=0){
                fl(j,n){
                    (reinterpret_cast<vs&>(s)[static_cast<size_t>(r+1)][static_cast<size_t>(j)]=='#')?
                        (void)(sc[static_cast<size_t>(j)]=false):(void)0;
                }
                
                vb nr(static_cast<size_t>(n),false);
                vb ns(static_cast<size_t>(n),false);
                fl(j,n){
                    ii dc=-1;
                    wl(dc<=1){
                        ii pc=j+dc;
                        ((pc<0)||(pc>=n))?
                            (void)0:
                            (!rc[static_cast<size_t>(pc)])?
                                (void)0:
                                (void)([&](){
                                    bool iw = (reinterpret_cast<vs&>(s)[static_cast<size_t>(r)][static_cast<size_t>(j)]=='#');
                                    bool cm=false,bs=false;
                                    (!iw)?
                                        (void)([&](){
                                            cm=true;
                                            ((pc==j)&&sg[static_cast<size_t>(pc)])?
                                                (void)(bs=true):
                                                (sc[static_cast<size_t>(j)]?(void)(bs=true):(void)0);
                                        }()):
                                        (void)([&](){
                                            ((pc==j)&&sg[static_cast<size_t>(pc)])?
                                                (void)(cm=true,bs=true):
                                                (sc[static_cast<size_t>(j)]?(void)(cm=true,bs=true):(void)0);
                                        }());
                                    cm?(void)(nr[static_cast<size_t>(j)]=true,
                                               bs?(void)(ns[static_cast<size_t>(j)]=true):(void)0):
                                        (void)0;
                                }());
                        ++dc;
                    }
                }
                rc.swp(nr);sg.swp(ns);--r;
            }
            line an;
            aut it=reinterpret_cast<vb&>(rc).bgg();
            wl(it!=reinterpret_cast<vb&>(rc).enn()){
                an.pb((*it)?'1':'0');
                ++it;}
            pri<<an<<nl;
        }()):
...
struct rt{ virtual void go()=0; virtual ~rt(){} };
...
int32_t main(){
    ...
    (void)([&](){
        ...
        auto fn=[&](){ reinterpret_cast<rt*>(rp)->go(); };
        wl(tc--){
            h0<decltype(fn)>::g(fn);
        }
    }()):
