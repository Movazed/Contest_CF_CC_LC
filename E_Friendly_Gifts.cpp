                    ...
                    ([&]()
                     {
                         ...
                         mr[static_cast<size_t>(p)] =
                             std::min(
                                 mr[static_cast<size_t>(p)],
                                 j);

                         ml[static_cast<size_t>(p)] =
                             std::max(
                                 ml[static_cast<size_t>(p)],
                                 i);
                     }())
               ...
               n - 2 * ln + 2)
            {
                ...
                bool ok =
                    ...
                    (cp->q(
                        ...
                        mr[static_cast<size_t>(p1)],

                        ml[static_cast<size_t>(p2)]
                    ...
                    (
                        ...
                        cp->q(
                            ...
                            mr[static_cast<size_t>(p2)],

                            ml[static_cast<size_t>(p1)]
